...
const Videos2U3D = ({ data, title }: Props) => {
  return (
    <div className="my-4">
                        ...
                        >
                          <div className="relative h-full bg-f6f6f6 flex justify-center items-center overflow-hidden">
                            ...
                            <div className="absolute top-2 right-2 group rounded-xl z-10">
                              <div className="p-1 bg-black/50 rounded-lg flex justify-center items-center group-hover:scale-110 transition-all duration-500">
                                <PlayIcon className="text-white" size={15} />
                              </div>
                            </div>
