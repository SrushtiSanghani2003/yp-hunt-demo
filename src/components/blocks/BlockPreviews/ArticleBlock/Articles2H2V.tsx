...
const Articles2H2V = ({ data, title }: Props) => {
  return (
    <div className="my-4">
                ...
                <div className="grid grid-cols-6 gap-3 h-72">
                  ...
                  {rawThird && (
                    <div className="col-span-2 h-full rounded-2xl overflow-hidden border border-primary flex flex-col">
                      <ArticlesMediaPreview item={rawThird} size="large"/>
                    </div>
                  )}

                  {rawFourth && (
                    <div className="col-span-2 h-full rounded-2xl overflow-hidden border border-primary flex flex-col">
                      <ArticlesMediaPreview item={rawFourth} size="large" />
                    </div>
                  )}
                </div>
              </SwiperSlide>
