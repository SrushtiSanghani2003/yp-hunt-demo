...
import { chevronDown, correctIcon, mediaIcon } from "../../icons";
...
const VideoVerticalBlock = ({
  ...
  return (
    <>
      <div className="pb-4 border-b-primary border-b-0.5 mt-4">
...
export default VideoVerticalBlock;
